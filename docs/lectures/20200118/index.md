...
# Lehetseges kerdesek a ropdogahoz

- POST, GET kozotti kulonbseg
- mire jo az expressjs
- mi a middleware, pelda
- mi a query string es mi a parameter, 1-1 pelda
- hogyan lesz elerheto a req.body
- mi a controller
- mi a request, response
- mi egy route, pelda egy letrehozasra

# Summary

- megtanultuk hogyan lehet debugolni node appot
  - vscode debuggerrel startoljuk az appot
  - elinditjuk az appot, es a vs code debuggerel attachelunk
  - bongeszoben a node debugger
- megbeszeltuk mi a request, response, a status code jelentoseget
- megneztuk mi van a headerben, h kuldunk post requestet
- voltak a protokollok es a portok
- expressjs
- routing
- mik a middlewarek
- feldolgoztunk bejovo requesteket
  - query string
  - param
  - req.body
- szolgaltunk ki statikus htmlelt
- epitettunk formot es kuldtunk post requestet
- mentettunk adatot db-be es vissza is toltottuk
